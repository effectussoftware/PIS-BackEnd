...
ActiveRecord::Schema.define(version: 20_211_006_035_031) do
  ...
  create_table 'exception_hunter_error_groups', force: :cascade do |t|
    ...
    t.index ['message'], name: 'index_exception_hunter_error_groups_on_message',
  ...
  create_table 'person_technologies', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[person_id technology_id],
            name: 'index_person_technologies_on_person_id_and_technology_id', unique: true
  ...
  create_table 'project_technologies', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[project_id technology_id],
            name: 'index_project_technologies_on_project_id_and_technology_id', unique: true
  ...
  add_foreign_key 'exception_hunter_errors', 'exception_hunter_error_groups',
