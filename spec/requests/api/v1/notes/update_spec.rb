describe 'POST api/v1/notes', type: :request do
  ...
  it 'should return success update' do
    post api_v1_project_notes_path(project.id), params: params, headers: auth_headers, as: :json
    put api_v1_project_note_path(project.id, project.notes[0].id), params: params2, headers: auth_headers, as: :json
